   ...
   <div class="main">
      <div class="mes-top-bar" style="display: flex; width: 100%;height: 100vh;">
         ...
         <div class="top-middle" style="flex-basis: 60%;border:1px solid lightgray;/* overflow: scroll; */position: relative;border-top: none;border-right: none;">
            <div class="top-area" style="height: 50px;width: 100%;border-bottom:1px solid lightgray;/* display: block; */">
               ...
               ?>
                  <div class="top-user-name-pic-wrap " style="display: flex;margin-left:5px;height: 100%;align-items: center;">
                     ...
                     <div class="top-msg-user-name align-middle" style="margin-left: 10px; font-size: 17px; font-weight:600;"><?php echo '' . $lastPersonIdFromPost->firstName . ' ' . $lastPersonIdFromPost->lastName . ''; ?></div>
                  </div>
               <?php } else {
               ?>
                  <div class="top-user-name-pic-wrap " style="display: flex;margin-left:5px;height: 100%;align-items: center;">
            ...
            <textarea name="" id="msgInput" cols="30" rows="10" placeholder="type a message... " style="height: 50px;width: 100%;border-radius:20px;position:absolute;bottom: 42px;
"></textarea>
         </div>
         <div class="top-right" style="flex-basis: 20%; border-bottom:1px solid lightgray;">
            ...
            <div class="right-users-details align-middle" style="height: 100%; flex-direction: column;margin-top: -100px;">
               ...
               <div class="users-right-pro-name" style="font-size: 20px;margin-top:10px; font-weight: 600;"><?php if (!empty($lastPersonIdFromPost)) {
                                                                                                               echo '' . $lastPersonIdFromPost->firstName . ' ' . $lastPersonIdFromPost->firstName . '';
                                                                                                            } ?>
               </div>
            </div>
         </div>
   ...
   <script>
      $(document).ready(function() {
         ...
         var BASEURL = 'http://localhost/facebookclone/';
         ...
         function userLoad() {
            ...
            $.post(BASEURL + 'core/ajax/mesgFetch.php', {
               loadUserid: userid
            }, function(data) {
         ...
         setTimeout(function() {
            $(document).on('keyup', '.emojionearea .emojionearea-editor', function(e) {
               if (e.keyCode === 13) {
                  ...
                  var msg = rawMsg.replace("<div><br></div>", "");
                  // console.log(msg, useridForAjax, otherid);


                  $.ajax({
                     type: "POST",
                     url: BASEURL + 'core/ajax/message.php',
                     data: {
         ...
         function loadMessage() {
            ...
            $.post(BASEURL + 'core/ajax/message.php', {
               dataCount: otheridd,
               profileid: useridd
            }, function(data) {

               // console.log(pastDataCount, data);
         ...
         $(document).on('keyup', 'input.user-search', function() {
            ...
            if (searchText === '') {
               ...
               $.post(BASEURL + 'core/ajax/search.php', {
                  msgUser: searchText,
                  userid: useridd
               }, function(data) {
                  if (data === '') {
         ...
         $(document).on('click', 'li.mention-individuals', function() {
            ...
            $.post(BASEURL + 'core/ajax/message.php', {
               ...
               $('.msg-box').html(data);
               $('.user-show').empty();
               $('.top-msg-user-photo').attr('src', searchName);

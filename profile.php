      ...
      <div class="main-area">
         ...
         ?>
            <div class="user-block-show-wrap" style="display:flex; justify-content:center;width:100%;">
               <div class="user-block-show" style="border:1px solid gray; border-radius:10px;background-color: white; padding: 20px; margin-top: 15px;">
                  <div class="block-icon-wrap" style="display: flex;">
                     <img src="assets/image/profile/block.JPG" alt="">
                     <div style="font-size: 18px; font-weight: 600;">Sorry, this is not for you!</div>
                  </div>
                  <hr>
                  <div style="font-size: 13px; font-weight: 300;">You have been blocked maybe...</div>
                  <div style="color:blue; display:flex; font-size: 14px;">
                     <a href="<?php echo $userData->userLink; ?>">Go back to your profile</a> <a href="/" style="margin-left: 10px;">Back to index</a>
                  </div>
                           ...
                           ?>
                              ...
                              <div class="block-wrap">
                                 <div class="block-action">
                                    <img src="assets/image/profile/dots.JPG" alt="Block">
                                 </div>
                                 <div class="block-show" data-userid="<?php echo $userid; ?>" data-userid="<?php echo $userid; ?>" data-profileid="<?php echo $profileId; ?>">
                                    block user
                                 </div>
                              </div>
                           <?php

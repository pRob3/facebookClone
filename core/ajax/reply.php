                        ...
                        <div class="reply-text-option-wrap align-middle">
                            <div class="com-pro-text align-middle">
                                ...
                                <div class="com-react-placeholder-wrap align-middle">
                                    <div class="com-text" data-commentid="<?php echo $reply->commentID; ?>" data-postid="<?php echo $reply->commentOn; ?>" data-profilepic="<?php echo $userData->profilePic; ?>" data-replyid="<?php echo $reply->commentID; ?>" data-userid="<?php echo $user_id; ?>" style="margin-left:5px;">
                                        <?php echo $reply->comment; ?>
                                    </div>
                                    <div class="com-nf-3-wrap">
                                        <?php
                                        if ($reply_react_count == '0') {
                                        } else {
                            ...
                            <div class="reply-dot-option-wrap">
                                <div class="reply-dot" style="margin-left:5px;cursor:pointer;color:gray;" data-postid="<?php echo $reply->commentOn ?>" data-userid="<?php echo $user_id; ?>" data-commentid="<?php echo $reply->commentID; ?>" data-replyid="<?php echo $reply->commentID; ?>">
                                    ...
                                </div>
                        ...
                        <div class="com-react">
                            <div class="com-like-react-reply" data-postid="<?php echo $reply->commentOn; ?>" data-userid="<?php echo $user_id; ?>" data-commentid="<?php
                                ...
                                <?php if (empty($replyReactCheck)) {
                                    ...
                                    echo 'reply-' . $replyReactCheck->reactType . '-action-text"><span>' . $replyReactCheck->reactType . '</span></div>';
                                } ?>
